"use strict";var n=require("path"),r=require("fs");function t(n){return n&&"object"==typeof n&&"default"in n?n:{default:n}}var e=t(n),i={subNavShow:[],ignoreFolders:[],ignoreFiles:[],dirPrefix:"📂  ",filePrefix:"✏️  "};function o(){return i||{}}var c=function(n,t,i){return void 0===t&&(t=[]),void 0===i&&(i=[]),r.readdirSync(n).sort().filter((function(o){var c=r.statSync(e.default.join(n,o)),a=o.slice(o.lastIndexOf(".")+1);return c.isFile()&&t.includes(a)&&u(o)&&!i.includes(o)}))},u=function(n){return"readme.md"!==n.toLocaleLowerCase()},a=function(n){void 0===n&&(n=".");var t=o(),i=r.readdirSync(n),c=[];return i.forEach((function(i){var o=e.default.join(n,i);r.statSync(o).isDirectory()&&!t.ignoreFolders.includes(i)&&c.push(o)})),c},f=a,s=function(n,r){void 0===r&&(r="");var t=o();return c(n,["md"],t.ignoreFiles).map((function(n){return r+n}))},l=function(n){return n.substring(n.lastIndexOf("/")+1,n.lastIndexOf("."))},d=function(n){return n.substring(n.lastIndexOf("/")+1)},v=function(n){var r=o(),t=[];f(n).sort().filter((function(n){return!r.ignoreFolders.includes(d(n))})).forEach((function(n){var e=d(n),i=f(n).map((function(n){var r,t,i=d(n),o=s(n)[0];return{text:i,link:null!==(t=null!==(r="/"+e+"/"+i+"/"+o)&&void 0!==r?r:l(o))&&void 0!==t?t:""}}));t.push({text:"".concat(r.dirPrefix).concat(e),items:i})}));var e=[];return(e=s(n)).length>0&&e.sort().filter((function(n){return!r.ignoreFiles.includes(l(n))})).forEach((function(n){t.push({text:"".concat(r.filePrefix).concat(l(n)),link:"/"+n})})),t};
/*! *****************************************************************************
